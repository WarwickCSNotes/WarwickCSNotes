...
const HowToContributePage = lazy(() =>
  import("./pages/how-to-contribute").then((m) => ({
    default: m.HowToContributePage,
  })),
)
      ...
      <BrowserRouter>
        ...
        >
          <Routes>
            ...
            <Route path="/resources/how-to-contribute" element={<HowToContributePage />} />

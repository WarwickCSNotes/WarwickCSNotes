...
const CALLOUT_TYPES: Record<string, CalloutStyle> = {
  ...
  definition:{ label: "Definition",icon: BookMarked,    container: "border-indigo-500/50 bg-indigo-500/10", title: "text-indigo-600 dark:text-indigo-400" },
  def:       { label: "Definition",icon: BookMarked,    container: "border-indigo-500/50 bg-indigo-500/10", title: "text-indigo-600 dark:text-indigo-400" },
